...
public class GrayConcreteWall extends Wall {
    public static final int BULLET_HEIGHT_PASS = Bullet.HIGH_BULLET;

    public GrayConcreteWall(int id,
